...
class OntListWithStatuses extends CDataAbstractModuleFD17xxV3
{
    /**
     * @var WrappedResponse[]
     */
    ...
    function fillBindStatuses(&$statuses)
    {
        ...
        foreach ($responses['ont.lastDownReason']->fetchAll() as $resp) {
            ...
            $iface = $this->parseInterface($index, '_snmp_id');
