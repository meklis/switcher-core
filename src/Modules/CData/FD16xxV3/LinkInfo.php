...
class LinkInfo extends CDataAbstractModuleFD16xxV3
{
    protected function formate() {
        ...
        foreach ($this->getPhysicalInterfaces() as   $port) {
            $indexes[$port['_snmp_id']]['interface'] = $port;
            $indexes[$port['_snmp_id']]['oper_status'] = null;
            $indexes[$port['_snmp_id']]['nway_status'] = null;
            $indexes[$port['_snmp_id']]['admin_state'] = null;
            $indexes[$port['_snmp_id']]['last_change'] = null;
            $indexes[$port['_snmp_id']]['medium_type'] = null;
        }
