    ...
    function getPretty()
    {
        return [
            'cpu' => [
                ...
                '_temperature' => (float)($this->getResponseByName('resources.temperature.cpu')->fetchAll()[0]->getValue()) / 10,
                '_temperature_threshold' => (float)($this->getResponseByName('resources.temperature.cpuTreshhold')->fetchAll()[0]->getValue()) / 10,
            ],
            'disk' => null,
            'interfaces' => null,
            'cards' => null,
