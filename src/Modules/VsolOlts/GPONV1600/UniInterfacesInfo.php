    ...
    function setUniPort($iface, $portNum)
    {
        $this->checkSnmpRespError($this->snmp->set(
            \SnmpWrapper\Oid::init(
                $this->oids->getOidByName('uni.control.set.ponNum')->getOid(),
                false,
                'Integer',
                $iface['_port']
            )
        ...
        $this->checkSnmpRespError($this->snmp->set(
            \SnmpWrapper\Oid::init(
                $this->oids->getOidByName('uni.control.set.onuNum')->getOid(),
                false,
                'Integer',
                $iface['_onu']
            )
        ...
        $this->checkSnmpRespError($this->snmp->set(
            \SnmpWrapper\Oid::init(
                $this->oids->getOidByName('uni.control.set.portNum')->getOid(),
                false,
                'Integer',
                $portNum
            )
