...
class OntDelete extends VsolOltsAbstractModule
{
    /**
     * @var WrappedResponse[]
     */
    ...
    public function run($filter = [])
    {
        ...
        $this->checkSnmpRespError($this->snmp->set(Oid::init($this->oids->getOidByName('ont.actions.action')->getOid(), false, 'Integer', 2)));
